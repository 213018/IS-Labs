...
namespace Theatre.Web.Controllers
{
    public class TheatreShowsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Place,ImageUrl,ShowDate")] TheatreShow theatreShow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Title,Description,Place,ImageUrl,ShowDate")] TheatreShow theatreShow)
        {
